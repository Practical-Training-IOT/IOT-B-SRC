...
// @Param data body driverPkg.Drivers true "创建drivers表"
...
// @Accept application/json
// @Produce application/json
// @Param data body driverPkg.Drivers true "删除drivers表"
...
// DeleteDriversByIds 批量删除drivers表
// @Tags Drivers
...
// UpdateDrivers 更新drivers表
// @Tags Drivers
// @Summary 更新drivers表
// @Security ApiKeyAuth
// @Accept application/json
// @Produce application/json
// @Param data body driverPkg.Drivers true "更新drivers表"
...
// FindDrivers 用id查询drivers表
// @Tags Drivers
// @Summary 用id查询drivers表
// @Security ApiKeyAuth
// @Accept application/json
// @Produce application/json
// @Param ID query uint true "用id查询drivers表"
